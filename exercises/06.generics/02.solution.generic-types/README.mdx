...
<EpicVideo url="https://www.epicweb.dev/workshops/type-safety/6-generics/generic-types/solution" />

👨‍💼 You've created reusable generic types!

🦉 The `LoadingState<Data>` pattern is extremely useful for modeling async
...
🦉 Avoid using generics to hide a cast. This looks type-safe but is not:

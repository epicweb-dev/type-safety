...
// ✅ Constrain T to types with length
...
3. Use `keyof` constraint for type-safe property access (we’ll cover type operators in depth in the Advanced TypeScript workshop)

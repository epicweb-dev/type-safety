...
Literal types are perfect for state machines:
...
<callout-info>
Literal types turn runtime errors into compile-time errors. If you typo a state
name, TypeScript catches it immediately.
</callout-info>

...
await testStep(
	'getProductSummary should format products correctly',
	async () => {
		...
		).toBe('Widget - $29.99: No description')
		expect(
		...
		).toBe('Gadget - $49.99: A fancy gadget')
	},
)
...
await testStep(
	'Product interface should allow optional description',
	async () => {

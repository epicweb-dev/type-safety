...
await testStep(
	'User should combine WithId, WithTimestamps, and user fields',
	async () => {
		const user: User = {
			id: 'user-1',
...
await testStep(
	'Post should combine WithId, WithTimestamps, WithAuthor, and post fields',
	async () => {
		const post: Post = {
			id: 'post-1',
			createdAt: new Date('2024-01-01'),
...
await testStep(
	'Comment should combine WithId, WithTimestamps, WithAuthor, and comment fields',
	async () => {
...
await testStep(
	'getAgeInDays should work with any entity that has WithTimestamps',
	async () => {
		const user: User = {
			id: 'user-1',
			createdAt: new Date('2024-01-01'),

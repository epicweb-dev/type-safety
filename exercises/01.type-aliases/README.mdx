...
- **Union/intersection types** - Type aliases are the only way to name these
...
<callout-info>
Type aliases are one of the most commonly used TypeScript features. They're the
foundation for building a well-typed codebase.
</callout-info>
